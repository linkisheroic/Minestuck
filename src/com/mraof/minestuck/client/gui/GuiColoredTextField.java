...
public class GuiColoredTextField extends Gui {
    ...
    private int backgroundColor = this.hexStringParser("f00000");

    public GuiColoredTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height, int color)
    {
        this.id = componentId;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
            {
                ...
                drawRect(this.x, this.y, this.x + this.width, this.y + this.height, backgroundColor | 0xFF000000);
            }
